...
// 设置建站起始时间（按需修改）
const startAt = new Date("2025-08-15T21:05:00+08:00").getTime();
...
.footer-outer {
  width: 100%;
  background: transparent; /* 黑色栏占满整行 */
  padding: 18px 0 28px; /* 上下间距，左右由内部容器控制 */
}

.footer {
  max-width: 1080px;
  margin: 0 auto;
  padding: 0 12px; /* 为小屏幕保留左右间距 */
  text-align: center;
  /* 内层去掉背景与圆角，让外层黑色条贯穿整行 */
